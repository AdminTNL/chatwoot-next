class Api::V1::Accounts::ContactsController < Api::V1::Accounts::BaseController
  ...
  def search
    ...
    contacts = contacts_access_scope.restrict(contacts)
  ...
  def resolved_contacts
    ...
    @resolved_contacts = contacts_access_scope.restrict(@resolved_contacts)

    @resolved_contacts = @resolved_contacts.tagged_with(params[:labels], any: true) if params[:labels].present?
    @resolved_contacts
  end

  def contacts_access_scope
    @contacts_access_scope ||= Contacts::AccessScope.new(account: Current.account, user: Current.user, account_user: Current.account_user)
  end
  ...
  def fetch_contact
    contact_scope = contacts_access_scope.restrict(Current.account.contacts)
